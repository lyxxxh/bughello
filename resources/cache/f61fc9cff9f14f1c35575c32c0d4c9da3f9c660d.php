...
<?php echo $__env->make("video_particles.banner",[
    'banners' => $banners
    ...
    <div class="row">
        ...
        <div class="stui-pannel stui-pannel-bg clearfix">
            ...
            <div class="stui-pannel_bd">
                <ul class="stui-vodlist clearfix">
                    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class='stui-vodlist__box'>
                         <a class='stui-vodlist__thumb lazyload' href='' title='' data-original='<?php echo e($video->pic); ?>'>
                    ...
                    <a href='dsfsf' title='f'><?php echo e($video->title); ?></a>
                    </h4>
                ...
                <?php echo $__env->make("video_particles.paginate",['paginator' => $videos ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.video_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/code/bughello/resources/views/video/index.blade.php ENDPATH**/ ?>